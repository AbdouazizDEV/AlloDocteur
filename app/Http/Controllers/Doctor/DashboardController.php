...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $totalAppointment = Appointment::where('doctor_id', Auth::id())->whereDate('created_at',Carbon::today())->count();
        ...
        return view('doctor.dashboard', compact('totalPatients','totalAppointment','completedAppointment','futureAppointment'));
    }
}
